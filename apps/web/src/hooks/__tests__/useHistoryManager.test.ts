...
describe('useHistoryManager', () => {
  ...
  // NOTE: Export State Rehydration tests removed (Story 4.3 bug fix)
  // Legacy embedded component rehydration was removed from useHistoryManager.
  // Questionnaire UI state is now managed by ChatInterface using useQuestionnairePersistence hook.
});
